...
class BurgersControllerTest < ActionController::TestCase
  ...
  test "should create burger" do
    assert_difference('Burger.count') do
      post :create, burger: { description: @burger.description, name: @burger.name, price_double: @burger.price_double, price_single: @burger.price_single, spicy: @burger.spicy }
    end
  ...
  test "should update burger" do
    patch :update, id: @burger, burger: { description: @burger.description, name: @burger.name, price_double: @burger.price_double, price_single: @burger.price_single, spicy: @burger.spicy }
    assert_redirected_to burger_path(assigns(:burger))
  end
